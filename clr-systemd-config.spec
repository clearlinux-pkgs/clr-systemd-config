...
Version  : 154
Release  : 183
URL      : http://localhost/cgit/projects/clr-systemd-config/snapshot/clr-systemd-config-154.tar.bz2
Source0  : http://localhost/cgit/projects/clr-systemd-config/snapshot/clr-systemd-config-154.tar.bz2
...
%prep
%setup -q -n clr-systemd-config-154
...
export LANG=C
export SOURCE_DATE_EPOCH=1527123658
