...
Version  : 175
Release  : 199
URL      : http://localhost/cgit/projects/clr-systemd-config/snapshot/clr-systemd-config-175.tar.gz
Source0  : http://localhost/cgit/projects/clr-systemd-config/snapshot/clr-systemd-config-175.tar.gz
...
%prep
%setup -q -n clr-systemd-config-175
...
export LANG=C
export SOURCE_DATE_EPOCH=1546895340
