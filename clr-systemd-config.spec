...
Version  : 185
Release  : 209
URL      : http://localhost/cgit/projects/clr-systemd-config/snapshot/clr-systemd-config-185.tar.xz
Source0  : http://localhost/cgit/projects/clr-systemd-config/snapshot/clr-systemd-config-185.tar.xz
...
%prep
%setup -q -n clr-systemd-config-185
...
export LANG=C
export SOURCE_DATE_EPOCH=1558653202
