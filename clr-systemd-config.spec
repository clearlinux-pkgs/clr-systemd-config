...
Version  : 181
Release  : 205
URL      : http://localhost/cgit/projects/clr-systemd-config/snapshot/clr-systemd-config-181.tar.xz
Source0  : http://localhost/cgit/projects/clr-systemd-config/snapshot/clr-systemd-config-181.tar.xz
...
%prep
%setup -q -n clr-systemd-config-181
...
export LANG=C
export SOURCE_DATE_EPOCH=1553802448
