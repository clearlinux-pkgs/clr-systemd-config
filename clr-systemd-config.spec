...
Version  : 176
Release  : 200
URL      : http://localhost/cgit/projects/clr-systemd-config/snapshot/clr-systemd-config-176.tar.xz
Source0  : http://localhost/cgit/projects/clr-systemd-config/snapshot/clr-systemd-config-176.tar.xz
...
%prep
%setup -q -n clr-systemd-config-176
...
export LANG=C
export SOURCE_DATE_EPOCH=1546903905
