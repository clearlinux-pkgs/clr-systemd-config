...
Version  : 187
Release  : 211
URL      : http://localhost/cgit/projects/clr-systemd-config/snapshot/clr-systemd-config-187.tar.xz
Source0  : http://localhost/cgit/projects/clr-systemd-config/snapshot/clr-systemd-config-187.tar.xz
...
%prep
%setup -q -n clr-systemd-config-187
...
export LANG=C
export SOURCE_DATE_EPOCH=1559857290
