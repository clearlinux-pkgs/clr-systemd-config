...
Version  : 177
Release  : 201
URL      : http://localhost/cgit/projects/clr-systemd-config/snapshot/clr-systemd-config-177.tar.xz
Source0  : http://localhost/cgit/projects/clr-systemd-config/snapshot/clr-systemd-config-177.tar.xz
...
%prep
%setup -q -n clr-systemd-config-177
...
export LANG=C
export SOURCE_DATE_EPOCH=1548706036
