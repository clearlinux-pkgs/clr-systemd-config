...
Version  : 192
Release  : 215
URL      : http://localhost/cgit/projects/clr-systemd-config/snapshot/clr-systemd-config-192.tar.xz
Source0  : http://localhost/cgit/projects/clr-systemd-config/snapshot/clr-systemd-config-192.tar.xz
...
%prep
%setup -q -n clr-systemd-config-192
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1567668638
