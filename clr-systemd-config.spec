...
Version  : 173
Release  : 197
URL      : http://localhost/cgit/projects/clr-systemd-config/snapshot/clr-systemd-config-173.tar.gz
Source0  : http://localhost/cgit/projects/clr-systemd-config/snapshot/clr-systemd-config-173.tar.gz
...
%prep
%setup -q -n clr-systemd-config-173
...
export LANG=C
export SOURCE_DATE_EPOCH=1544728285
