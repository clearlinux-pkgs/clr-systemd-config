...
Version  : 160
Release  : 189
URL      : http://localhost/cgit/projects/clr-systemd-config/snapshot/clr-systemd-config-160.tar.bz2
Source0  : http://localhost/cgit/projects/clr-systemd-config/snapshot/clr-systemd-config-160.tar.bz2
...
%prep
%setup -q -n clr-systemd-config-160
...
export LANG=C
export SOURCE_DATE_EPOCH=1534187684
