...
Version  : 188
Release  : 212
URL      : http://localhost/cgit/projects/clr-systemd-config/snapshot/clr-systemd-config-188.tar.xz
Source0  : http://localhost/cgit/projects/clr-systemd-config/snapshot/clr-systemd-config-188.tar.xz
...
%prep
%setup -q -n clr-systemd-config-188
...
export LANG=C
export SOURCE_DATE_EPOCH=1561407210
