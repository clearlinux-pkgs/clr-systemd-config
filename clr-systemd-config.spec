...
Version  : 197
Release  : 223
URL      : http://localhost/cgit/projects/clr-systemd-config/snapshot/clr-systemd-config-197.tar.xz
Source0  : http://localhost/cgit/projects/clr-systemd-config/snapshot/clr-systemd-config-197.tar.xz
...
%prep
%setup -q -n clr-systemd-config-197
cd %{_builddir}/clr-systemd-config-197
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1582757440
...
cp %{_builddir}/clr-systemd-config-197/LICENSE %{buildroot}/usr/share/package-licenses/clr-systemd-config/01a6b4bf79aca9b556822601186afab86e8c4fbf
%make_install
