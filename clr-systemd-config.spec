...
Version  : 146
Release  : 173
URL      : http://localhost/cgit/projects/clr-systemd-config/snapshot/clr-systemd-config-146.tar.gz
Source0  : http://localhost/cgit/projects/clr-systemd-config/snapshot/clr-systemd-config-146.tar.gz
...
%prep
%setup -q -n clr-systemd-config-146
...
export LANG=C
export SOURCE_DATE_EPOCH=1511962803
