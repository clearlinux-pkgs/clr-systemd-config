...
Version  : 180
Release  : 204
URL      : http://localhost/cgit/projects/clr-systemd-config/snapshot/clr-systemd-config-180.tar.xz
Source0  : http://localhost/cgit/projects/clr-systemd-config/snapshot/clr-systemd-config-180.tar.xz
...
%prep
%setup -q -n clr-systemd-config-180
...
export LANG=C
export SOURCE_DATE_EPOCH=1553288938
