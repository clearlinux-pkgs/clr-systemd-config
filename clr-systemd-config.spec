...
Version  : 171
Release  : 195
URL      : http://localhost/cgit/projects/clr-systemd-config/snapshot/clr-systemd-config-171.tar.bz2
Source0  : http://localhost/cgit/projects/clr-systemd-config/snapshot/clr-systemd-config-171.tar.bz2
...
%prep
%setup -q -n clr-systemd-config-171
...
export LANG=C
export SOURCE_DATE_EPOCH=1542656621
