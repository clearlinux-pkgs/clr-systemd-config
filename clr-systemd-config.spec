...
Version  : 178
Release  : 202
URL      : http://localhost/cgit/projects/clr-systemd-config/snapshot/clr-systemd-config-178.tar.xz
Source0  : http://localhost/cgit/projects/clr-systemd-config/snapshot/clr-systemd-config-178.tar.xz
...
%prep
%setup -q -n clr-systemd-config-178
...
export LANG=C
export SOURCE_DATE_EPOCH=1550249439
