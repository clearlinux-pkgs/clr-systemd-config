...
Version  : 165
Release  : 193
URL      : http://localhost/cgit/projects/clr-systemd-config/snapshot/clr-systemd-config-165.tar.bz2
Source0  : http://localhost/cgit/projects/clr-systemd-config/snapshot/clr-systemd-config-165.tar.bz2
...
Requires: clr-systemd-config-license
...
%prep
%setup -q -n clr-systemd-config-165
...
export LANG=C
export SOURCE_DATE_EPOCH=1537460307
...
export SOURCE_DATE_EPOCH=1537460307
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/doc/clr-systemd-config
cp LICENSE %{buildroot}/usr/share/doc/clr-systemd-config/LICENSE
%make_install
...
%files license
%defattr(-,root,root,-)
/usr/share/doc/clr-systemd-config/LICENSE
