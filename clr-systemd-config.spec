...
Version  : 174
Release  : 198
URL      : http://localhost/cgit/projects/clr-systemd-config/snapshot/clr-systemd-config-174.tar.gz
Source0  : http://localhost/cgit/projects/clr-systemd-config/snapshot/clr-systemd-config-174.tar.gz
...
%prep
%setup -q -n clr-systemd-config-174
...
export LANG=C
export SOURCE_DATE_EPOCH=1546471371
