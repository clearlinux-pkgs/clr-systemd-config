...
Version  : 186
Release  : 210
URL      : http://localhost/cgit/projects/clr-systemd-config/snapshot/clr-systemd-config-186.tar.xz
Source0  : http://localhost/cgit/projects/clr-systemd-config/snapshot/clr-systemd-config-186.tar.xz
...
%prep
%setup -q -n clr-systemd-config-186
...
export LANG=C
export SOURCE_DATE_EPOCH=1559117225
