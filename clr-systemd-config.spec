...
Version  : 147
Release  : 174
URL      : http://localhost/cgit/projects/clr-systemd-config/snapshot/clr-systemd-config-147.tar.gz
Source0  : http://localhost/cgit/projects/clr-systemd-config/snapshot/clr-systemd-config-147.tar.gz
...
%prep
%setup -q -n clr-systemd-config-147
...
export LANG=C
export SOURCE_DATE_EPOCH=1513891114
