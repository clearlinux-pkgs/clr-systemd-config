...
Version  : 172
Release  : 196
URL      : http://localhost/cgit/projects/clr-systemd-config/snapshot/clr-systemd-config-172.tar.bz2
Source0  : http://localhost/cgit/projects/clr-systemd-config/snapshot/clr-systemd-config-172.tar.bz2
...
%prep
%setup -q -n clr-systemd-config-172
...
export LANG=C
export SOURCE_DATE_EPOCH=1543270730
