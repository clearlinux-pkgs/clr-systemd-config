...
Version  : 157
Release  : 185
URL      : http://localhost/cgit/projects/clr-systemd-config/snapshot/clr-systemd-config-157.tar.bz2
Source0  : http://localhost/cgit/projects/clr-systemd-config/snapshot/clr-systemd-config-157.tar.bz2
...
%prep
%setup -q -n clr-systemd-config-157
...
export LANG=C
export SOURCE_DATE_EPOCH=1529707671
