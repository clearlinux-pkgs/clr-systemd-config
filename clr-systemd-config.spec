...
Version  : 199
Release  : 225
URL      : http://localhost/cgit/projects/clr-systemd-config/snapshot/clr-systemd-config-199.tar.xz
Source0  : http://localhost/cgit/projects/clr-systemd-config/snapshot/clr-systemd-config-199.tar.xz
...
%prep
%setup -q -n clr-systemd-config-199
cd %{_builddir}/clr-systemd-config-199
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1589584362
...
cp %{_builddir}/clr-systemd-config-199/LICENSE %{buildroot}/usr/share/package-licenses/clr-systemd-config/01a6b4bf79aca9b556822601186afab86e8c4fbf
%make_install
