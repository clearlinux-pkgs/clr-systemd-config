...
Version  : 150
Release  : 179
URL      : http://localhost/cgit/projects/clr-systemd-config/snapshot/clr-systemd-config-150.tar.bz2
Source0  : http://localhost/cgit/projects/clr-systemd-config/snapshot/clr-systemd-config-150.tar.bz2
...
%prep
%setup -q -n clr-systemd-config-150
...
export LANG=C
export SOURCE_DATE_EPOCH=1521658043
