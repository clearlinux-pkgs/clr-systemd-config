...
Version  : 161
Release  : 190
URL      : http://localhost/cgit/projects/clr-systemd-config/snapshot/clr-systemd-config-161.tar.bz2
Source0  : http://localhost/cgit/projects/clr-systemd-config/snapshot/clr-systemd-config-161.tar.bz2
...
%prep
%setup -q -n clr-systemd-config-161
...
export LANG=C
export SOURCE_DATE_EPOCH=1534197938
