...
Version  : 153
Release  : 182
URL      : http://localhost/cgit/projects/clr-systemd-config/snapshot/clr-systemd-config-153.tar.bz2
Source0  : http://localhost/cgit/projects/clr-systemd-config/snapshot/clr-systemd-config-153.tar.bz2
...
%prep
%setup -q -n clr-systemd-config-153
...
export LANG=C
export SOURCE_DATE_EPOCH=1526923111
