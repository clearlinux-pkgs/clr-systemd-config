...
Version  : 170
Release  : 194
URL      : http://localhost/cgit/projects/clr-systemd-config/snapshot/clr-systemd-config-170.tar.bz2
Source0  : http://localhost/cgit/projects/clr-systemd-config/snapshot/clr-systemd-config-170.tar.bz2
...
%prep
%setup -q -n clr-systemd-config-170
...
export LANG=C
export SOURCE_DATE_EPOCH=1540467322
