...
Version  : 184
Release  : 208
URL      : http://localhost/cgit/projects/clr-systemd-config/snapshot/clr-systemd-config-184.tar.xz
Source0  : http://localhost/cgit/projects/clr-systemd-config/snapshot/clr-systemd-config-184.tar.xz
...
%prep
%setup -q -n clr-systemd-config-184
...
export LANG=C
export SOURCE_DATE_EPOCH=1557162960
