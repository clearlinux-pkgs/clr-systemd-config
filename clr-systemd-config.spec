...
Version  : 159
Release  : 188
URL      : http://localhost/cgit/projects/clr-systemd-config/snapshot/clr-systemd-config-159.tar.bz2
Source0  : http://localhost/cgit/projects/clr-systemd-config/snapshot/clr-systemd-config-159.tar.bz2
...
%prep
%setup -q -n clr-systemd-config-159
...
export LANG=C
export SOURCE_DATE_EPOCH=1532658332
