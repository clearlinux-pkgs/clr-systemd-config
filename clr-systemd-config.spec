...
Version  : 156
Release  : 184
URL      : http://localhost/cgit/projects/clr-systemd-config/snapshot/clr-systemd-config-156.tar.bz2
Source0  : http://localhost/cgit/projects/clr-systemd-config/snapshot/clr-systemd-config-156.tar.bz2
...
%prep
%setup -q -n clr-systemd-config-156
...
export LANG=C
export SOURCE_DATE_EPOCH=1529014392
