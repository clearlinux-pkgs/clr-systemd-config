...
Version  : 209
Release  : 264
URL      : http://localhost/cgit/projects/clr-systemd-config/snapshot/clr-systemd-config-209.tar.gz
Source0  : http://localhost/cgit/projects/clr-systemd-config/snapshot/clr-systemd-config-209.tar.gz
...
%prep
%setup -q -n clr-systemd-config-209
cd %{_builddir}/clr-systemd-config-209
pushd ..
cp -a clr-systemd-config-209 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1749752083
